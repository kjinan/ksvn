...
/**
 * 提交到仓库 这块看官方demno的意思如果不用权限认证，会使用a session user
 * name作为提交的author，但是我试了会报错401，author required~
 * 本例是基于初始仓库图A转换为目标仓库图B的过程，我们需要执行的操作有： 1.删除nodeB/itemB1 2.编辑nodeC/itemC1
 * 3.新增nodeC/itemC2，并设置itemC2的文件属性 4.新增nodeB子节点nodeD
 */
public class CommitToRepository1 {
